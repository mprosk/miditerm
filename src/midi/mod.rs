...
const MIDI_CH_MODE_ALL_SOUNDS_OFF: u8 = 120_u8;
const MIDI_CH_MODE_RESET_ALL_CONTROLLERS: u8 = 121_u8;
const MIDI_CH_MODE_LOCAL_CONTROL: u8 = 122_u8;
const MIDI_CH_MODE_ALL_NOTES_OFF: u8 = 123_u8;
const MIDI_CH_MODE_OMNI_MODE_OFF: u8 = 124_u8;
const MIDI_CH_MODE_OMNI_MODE_ON: u8 = 125_u8;
const MIDI_CH_MODE_MONO_MODE_ON: u8 = 126_u8;
const MIDI_CH_MODE_POLY_MODE_ON: u8 = 127_u8;
